...
namespace CourseFlow.Api.Migrations.Application
{
    ...
    [Migration("20260206175518_AddIdentityUserRelationToStudent")]
    partial class AddIdentityUserRelationToStudent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CourseFlow.Api.Enrollment", b =>
                {
                    ...
                    b.Property<DateTime>("EnrollmentDateUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2026, 2, 6, 17, 55, 17, 961, DateTimeKind.Utc).AddTicks(200))
