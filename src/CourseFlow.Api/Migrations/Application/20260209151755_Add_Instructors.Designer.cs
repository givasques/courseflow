...
namespace CourseFlow.Api.Migrations.Application
{
    ...
    [Migration("20260209151755_Add_Instructors")]
    partial class Add_Instructors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseFlow.Api.Enrollment", b =>
                {
                    ...
                    b.Property<DateTime>("EnrollmentDateUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2026, 2, 9, 15, 17, 54, 536, DateTimeKind.Utc).AddTicks(9921))
            ...
            modelBuilder.Entity("CourseFlow.Api.Instructor", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("CourseFlow.Api.Course", b =>
                {
                    b.HasOne("CourseFlow.Api.Instructor", "Instructor")
                        .WithMany("Courses")
